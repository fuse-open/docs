...
The full source code for the app is available [here](https://github.com/fusetools/hikr/tree/models-chapter-7).
...
Also make sure you add an import statement to the top of `Models/App.js`:
